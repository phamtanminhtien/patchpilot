...
export function WorkspaceLayout({
  ...
  return (
    <section className="grid h-[calc(100vh-2.75rem)] min-h-0 grid-rows-[auto_minmax(0,1fr)] overflow-hidden lg:grid-cols-[3.25rem_16.5rem_minmax(0,1fr)] lg:grid-rows-1">
      {activityRail}
